...
public class GreenhouseBlazorModule : AbpModule
{
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles("/Iot.Greenhouse.Blazor.styles.css");
                }
            );
        });
    }
    ...
    private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
    {
        if (hostingEnvironment.IsDevelopment())
        {
            ...
            {
                options.FileSets.ReplaceEmbeddedByPhysical<GreenhouseDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Iot.Greenhouse.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<GreenhouseDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Iot.Greenhouse.Domain"));
                options.FileSets.ReplaceEmbeddedByPhysical<GreenhouseApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Iot.Greenhouse.Application.Contracts"));
                options.FileSets.ReplaceEmbeddedByPhysical<GreenhouseApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Iot.Greenhouse.Application"));
